              ...
              <Reveal delay={0.06}>
                <div className="case-study-panel">
                  ...
                  <p>
                    ...
                    avatar URL, site role, and membership tier, all available server- and
                    ...
                    room authentication issued by a dedicated API route. Styling is Tailwind
                    CSS 4 with CSS custom properties for theming, and next-themes handles
              ...
              <Reveal delay={0.14}>
                <div className="case-study-panel">
                  ...
                  <p>
                    ...
                    server-side API route. The media upload pipeline is separate from both:
                    eight distinct upload endpoints handle different content types (post
                    images, blog cover images, blog inline blocks, chat attachments, user
                    avatars, user banners, group assets), each storing metadata as JSON
                    on the relevant database record. User avatar and banner uploads enter
              ...
              <Reveal delay={0.18}>
                <div className="case-study-panel">
                  ...
                  <p>
                    ...
                    community or group posts — admins can dismiss the report or delete
                    the post, which simultaneously resolves all associated reports.
                    Building all of this required consistent patterns across very different
                    content types without duplicating business logic.
                  </p>
                </div>
              </Reveal>
              ...
              <Reveal delay={0.22}>
                <div className="case-study-panel">
                  ...
                  <p>
                    ...
                    two real-time systems, and an admin layer that covers every content
                    type. Remaining active work includes: Stripe integration for membership
            ...
            <div className="case-study-grid">
              <Reveal>
                <div className="case-study-panel">
                  ...
                  <p>
                    ...
                    quote posts (repost with commentary, embedding the original). The compose
                    modal includes an emoji picker, @mention autocomplete, and up to four
                    media attachments displayed in a responsive grid. Posts with image
                    attachments enter an admin approval queue; text-only posts publish
                    immediately. Any member can report a post; reports surface in the admin
                    panel. My Feed personalizes the view by surfacing posts from followed
                    members and friends.
                  </p>
                </div>
              </Reveal>
              ...
              <Reveal delay={0.06}>
                <div className="case-study-panel">
                  <h3>Groups</h3>
                  <p>
                    Sub-communities with three privacy tiers: Public (open join), Invite-Only
                    Visible (requires approval), and Invite-Only Secret (hidden from
                    non-members). Each group has its own feed, media gallery, member list,
                    and settings panel. Member roles — ADMIN, MOD, MEMBER — carry distinct
                    capabilities: mods can delete posts, lock comments, and kick members;
                    group admins control all settings and cannot be demoted. Admins can
                    toggle comments, new posts, likes, and member-initiated invites on or
                    off at the group level. New groups and name/description changes enter
                    the site admin&apos;s approval queue.
                  </p>
                </div>
              </Reveal>
              ...
              <Reveal delay={0.1}>
                <div className="case-study-panel">
                  ...
                  <p>
                    ...
                    and edit or delete their own messages (edited messages show an indicator).
                    LiveKit powers voice and video sessions in any room: token-based auth,
                    microphone/camera toggles, active speaker detection, and adaptive
                    bitrate streaming. Presence is tracked per room with join/leave events
                    broadcast to all participants. The Pro Lounge room is gated to
                    Pro and Lifetime members only.
                  </p>
                </div>
              </Reveal>
              ...
              <Reveal delay={0.14}>
                <div className="case-study-panel">
                  ...
                  <p>
                    ...
                    carries a cover image (used as the listing card thumbnail), category,
                    emoji tag, excerpt, and estimated read time. Members can like posts and
                    leave threaded comments. Blog posts enter an admin review queue before
                    going public. Admins can mark posts as featured — featured posts
                    display in a hero position at the top of the listing page. The listing
                    can be sorted by most liked, most recent, or posts from followed authors.
                  </p>
                </div>
              </Reveal>
              ...
              <Reveal delay={0.18}>
                <div className="case-study-panel">
                  ...
                  <p>
                    ...
                    single entry ("Jane and 2 others liked your post") rather than flooding
                    the list. Desktop shows a bell icon with unread count badge; mobile
                    shows a red badge on the profile avatar. Opening the panel auto-marks
                    all as read and clears the badge. The social graph supports one-way
                    follows (surfaces activity in My Feed) and bidirectional friend requests
                    with accept/reject flow — Friends-only posts are visible exclusively
                    to mutual friends.
                  </p>
                </div>
              </Reveal>
              ...
              <Reveal delay={0.22}>
                <div className="case-study-panel">
                  ...
                  <p>
                    A two-column admin panel with a sticky sidebar navigating ten moderation
                    queues: community posts, blogs, testimonials, groups, group posts, group
                    edits, reports, and avatar/banner uploads. Every action requires a
                    confirmation modal. Avatar and banner reviews show pending versus
                    currently approved images side by side. Membership is tiered (Free,
                    Pro Monthly, Pro Quarterly, Pro Yearly, Lifetime), with tier-gated
                    features including the Pro Lounge, HD video, direct messaging, and
                    private group creation. The upgrade page includes a feature comparison
                    table and trust badges.
                  </p>
                </div>
              </Reveal>
            </div>
